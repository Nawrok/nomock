...
class InMemoryJpaRepositoryTest extends Specification {
    ...
    def "FindAllById"() {
        given:
            def savedEntities = repository.saveAll([
                    new BookEntity("name1"),
    ...
    def "GetReferenceById"() {
        ...
        when:
            BookEntity fetchedEntity = repository.getReferenceById(savedEntityId)
        ...
        when: "entity with given ID does not exists"
            repository.getReferenceById(savedEntityId + 1)
    ...
    def "Repository should thrown IllegalArgumentException when null is passed to repository method"() {
        ...
        where:
            methodCallWithNullArgument << [{ -> repository.save(null) },
                                           ...
                                           { -> repository.getReferenceById(null) },]
    }
